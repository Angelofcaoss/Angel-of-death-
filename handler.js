...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Death (https://wa.me/573216796506) */
...
—◉ *Contacto para apelaciones:* wa.me/573216796506
╚═════════════════════════╝
               `.trim();
              m.reply(messageText);
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Angel of Death 👑;;;\nFN:Angel of Death 👑\nORG:Angel of Death 👑\nTITLE:\nitem1.TEL;waid=573216796506:+57 321 679 6506\nitem1.X-ABLabel:Angel of Death 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:Angel of Death 👑\nEND:VCARD`;
        await this.sendMessage(nk.from, {contacts: {displayName: 'Angel of Death 👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'Angel of caos - bot', thumbnail: imagen1, sourceUrl: 'https://github.com/Angelofcaoss/Angel-of-death-'}}}}, aa);
